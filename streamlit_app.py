...
st.markdown(
  ...
  :root{
    ...
    --input-bg:#343A40;          /* inputs, selects, uploader */
    --placeholder:#9AA0A6;

    /* Analyze button (DARK): teal */
    --btn1:#0f766e;
    --btn2:#10b981;
  ...
  @media (prefers-color-scheme: light){
    :root{
      ...
      --input-bg:#ffffff;        /* textareas, selects, uploader become white */
      --placeholder:#6b7280;

      /* Analyze button (LIGHT): purple → blue, as requested */
      --btn1:#4338ca;
      --btn2:#2563eb;
      --btn1-hover:#3730a3; --btn2-hover:#1d4ed8;
      --btn1-active:#312e81; --btn2-active:#1e40af;

      /* Hero title gradient on light */
      --hero1:#1f2937;
      --hero2:#2563eb;
    }

    /* Nicer hero background for light */
    .hero{
  ...
  .hero{
    ...
    /* dark theme hero bg stays as before */
  ...
  /* Ensure markdown text/headers obey theme color */
  ...
  /* Paint dropzone and inner layers with theme input color */
  ...
  /* Make ONLY "Browse files" clickable */
  ...
  .stFileUploader [data-testid="stFileUploaderDropzone"] input[type="file"] {
    pointer-events: none !important;      /* disable the big surface */
    cursor: default !important;
  }
  .stFileUploader [data-testid="stFileUploaderDropzone"] button,
  .stFileUploader [data-testid="stFileUploaderDropzone"] button * {
    pointer-events: auto !important;      /* only the button works */
    cursor: pointer !important;
    position: relative;
    z-index: 10;
  }
  .stFileUploader [data-testid="stFileUploaderDropzone"]:hover { filter: none !important; }
  ...
  /* Plotly label readability only (don’t change traces) */
